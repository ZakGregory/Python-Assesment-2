...
def five():
	a=random.randint(50,100)*2
	b=random.randint(50,100)*2
	c=random.randint(50,100)*2
	d=random.randint(50,100)*2
	e=random.randint(50,100)*2
	return [a,b,c,d,e]
...
def nine(string1, string2):
	...
	if len(string2)-len(list2)==len(string1):
		return True
	else:
		return False
